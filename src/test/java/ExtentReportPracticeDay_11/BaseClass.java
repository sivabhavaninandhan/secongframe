package ExtentReportPracticeDay_11;
...
public class BaseClass {
	...
	{
		ExtentSparkReporter sparkreporter=new ExtentSparkReporter("AllTestsFourteen.html");
	...
	{
		extentReports.flush();
		Desktop.getDesktop().browse(new File("AllTestsFourteen.html").toURI());
	}
	@AfterMethod
