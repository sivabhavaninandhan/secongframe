...
import ExtentReportPracticeDay_09.DataProviderextenttest;

public class ExtentTestcasesTen extends BaseClassnine{
	
	@Test(testName="TestORNG",dataProvider="validation",dataProviderClass=DataProviderextenttest.class)
