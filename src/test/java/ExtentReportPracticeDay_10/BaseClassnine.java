package ExtentReportPracticeDay_10;
...
public class BaseClassnine {
	...
	{
		ExtentSparkReporter sparkreporter=new ExtentSparkReporter("AllTestThirteen.html");
	...
	{
		extentReports.flush();
		Desktop.getDesktop().browse(new File("AllTestThirteen.html").toURI());
	}
	@AfterMethod
	...
	public String Capturescreen(String imgphoto) throws IOException
	{
		Date dt=new Date();
		String timestamp=dt.toString().replace(":", "_").replace(" ", "");
		
		String excelpath="./screen119/"+timestamp+imgphoto;
		
		TakesScreenshot ts=(TakesScreenshot)driver;
		File src=ts.getScreenshotAs(OutputType.FILE);
		File dst=new File(excelpath);
