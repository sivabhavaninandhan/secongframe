package ExtentReportPracticeDay_09;
...
public class BaseClassTen {
	...
	{
		ExtentSparkReporter sparkReporter=new ExtentSparkReporter("AllTeststweleve.html");
	...
	{
		extentReports.flush();
		Desktop.getDesktop().browse(new File("AllTeststweleve.html").toURI());
	}
	 @AfterMethod
	...
	public String Capturescreen(String imgname) throws IOException
	{
		...
		String path="./screen118/"+timestamp+imgname;
